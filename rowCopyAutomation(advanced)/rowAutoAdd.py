...
for stockCnt in range(wb2FirstCell, wb2LastCell):
  if wb2Sheet.cell(stockCnt, 5).value == None or wb2Sheet.cell(stockCnt, 5).value == "":
    continue
  stockList[wb2Sheet.cell(stockCnt, 5).value.replace(" ", "")] = wb2Sheet.cell(stockCnt, 15).value
