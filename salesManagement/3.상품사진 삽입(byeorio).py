...
cur = con.cursor()
cur.execute("SELECT PrdName, prdCode, Season, Url, SeasonDetail from ProductsData")
data = cur.fetchall()
for i in data:
...
for file in excelFileList:
  ...
  for i in range(first_row, last_row):
    try:
      ...
      if sheet1.cell(row=i, column=4).value == None or sheet1.cell(row=i, column=4).value == '':
        ...
        if sheet1.cell(row=i, column=4).value in prdBYEORIO:
  ...
  for i in range(first_row, last_row):
    if sheet1.cell(row=i, column=7).value == None or sheet1.cell(row=i, column=7).value == '' or sheet1.cell(row=i, column=4).value not in prdBYEORIO:
        continue
    else:
  ...
  for i in range(first_row, last_row):
    if sheet1.cell(row=i, column=34).value == None or sheet1.cell(row=i, column=34).value == '' or sheet1.cell(row=i, column=4).value not in prdBYEORIO:
        continue
    else:
  ...
  for i in range(first_row, last_row):
    if sheet1.cell(row=i, column=10).value == None or sheet1.cell(row=i, column=10).value == '' or sheet1.cell(row=i, column=4).value not in prdBYEORIO:
        continue
    else:
      salesInfoChannel[arrangeChannel(sheet1.cell(row=i, column=10).value)] = sheet1.cell(row=i, column=11).value
  
  for i in range(first_row, last_row):
    if sheet1.cell(row=i, column=19).value == None or sheet1.cell(row=i, column=19).value == '' or sheet1.cell(row=i, column=4).value not in prdBYEORIO:
        continue
    else:
      salesInfoQnt[sheet1.cell(row=i, column=19).value] = sheet1.cell(row=i, column=20).value
  
  for i in range(first_row, last_row):
    if sheet1.cell(row=i, column=37).value == None or sheet1.cell(row=i, column=37).value == '' or sheet1.cell(row=i, column=4).value not in prdBYEORIO:
        continue
    else:
