...
# json 파일 백업
from_jsonFile_path = './json/salesTotal.json'
to_jsonFile_path = './json/total_backup/salesTotal_backup.json'
...
with open('./json/salesTotal.json', 'r', encoding='UTF-8') as t:
  salesTotalData = json.load(t)

with open('./json/salesTotal.json', 'w', encoding='UTF-8') as outfile:
